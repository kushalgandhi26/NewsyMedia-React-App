...
const News = (props) => {
    ...
    useEffect(() => {
        document.title = `${capitalize(props.category)} - NewsyMedia`;
        loadNews();
    ...
    return (
        <>
            <h1 className="text-center" style={{ margin: '25px', marginTop:'90px' }}>Top {capitalize(props.category)} HeadLines</h1>
            {loading && <Spinner />}
            <InfiniteScroll
